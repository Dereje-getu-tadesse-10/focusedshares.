...
export const metadata: Metadata = {
  title: 'Privacy - Focused Shares',
  description: 'Focused Shares privacy. Learn more about our privacy.',
  openGraph: {
    type: 'website',
    locale: 'en_US',
    ...
    description: 'Focused Shares privacy. Learn more about our privacy.',
    siteName: 'Privacy - Focused Shares',
    images: [
      {
        url: 'https://res.cloudinary.com/ddugf28mx/image/upload/f_auto,q_auto/v1/focusedshares/mut3m9pdjxuzlc3z6jxn',
        width: 1200,
        height: 630,
        alt: 'Privacy - Focused Shares',
      },
    ],
  },
  twitter: {
...
const Page = () => {
  return (
    <main className='terms'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Focused Shares.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Focused Shares, accessible from{' '}
            <a
              href='https://focusedshares.com'
      ...
      <ul>
        <li>By email: hello@dereje.fr</li>
      </ul>
    </main>
  );
};
