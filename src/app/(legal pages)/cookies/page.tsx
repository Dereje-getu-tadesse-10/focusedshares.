const Page = () => (
  <>
    ...
    <p>
      This is the Cookie Policy for Focused shares, accessible from
      focusedshares.com
    </p>
    <p>
    ...
    <ul>
      <li>
        <p>
          ...
          these to work the following social media sites including; Google
          Sign-In, will set cookies through our site which may be used to
