  ...
  <main className='terms'>
    ...
    <ol type='a'>
      <li>
        ...
        (information or software) on Focused shares&apos;s web site for
      ...
      <li>
        ...
        restrictions and may be terminated by Focused shares at any time. Upon
    ...
    <ol type='a'>
      <li>
        The materials on Focused shares&apos;s web site are provided as is.
        Focused shares makes no warranties, expressed or implied, and hereby
        disclaims and negates all other warranties, including without
        limitation, implied warranties or conditions of merchantability, fitness
        for a particular purpose, or non-infringement of intellectual property
        or other violation of rights. Further, Focused shares does not warrant
    ...
    <p>
      In no event shall Focused shares or its suppliers be liable for any
      damages (including, without limitation, damages for loss of data or
      profit, or due to business interruption,) arising out of the use or
      inability to use the materials on Focused shares&apos;s Internet site,
      even if Focused shares or a Focused shares authorized representative has
    ...
    <p>
      The materials appearing on Focused shares&apos;s web site could include
      technical, typographical, or photographic errors. Focused shares does not
      warrant that any of the materials on its web site are accurate, complete,
      or current. Focused shares may make changes to the materials contained on
      its web site at any time without notice. Focused shares does not, however,
    ...
    <p>
      Focused shares has not reviewed all of the sites linked to its Internet
      web site and is not responsible for the contents of any such linked site.
      The inclusion of any link does not imply endorsement by Focused shares of
    ...
    <p>
      Focused shares may revise these terms of use for its web site at any time
    ...
    <p>
      Any claim relating to Focused sharesa&apos;s web site shall be governed by
      the laws of the State of Doubs without regard to its conflict of law
      provisions.
    </p>
